        ...
        <div class="col-sm-12 col-md-10 col-md-offset-1">
            ...
            <?php foreach ($lesproduits  as $key => $value) : ?>
                    <tr>
                        ...
                        <div class="media">
                            <a class="thumbnail pull-left" href="#"> <img class="media-object" src ="<?= $lesproduits->displayImage(); ?> style="width: 72px; height: 72px;""> </a>
                      <!--  <a class="thumbnail pull-left" href="#"> <img class="media-object" src="http://icons.iconarchive.com/icons/custom-icon-design/flatastic-2/72/product-icon.png" style="width: 72px; height: 72px;"> </a>-->
                        ...
                        <input type="email" class="form-control" id="exampleInputEmail1" value="<?= $lepannier[$value->id] ; ?>">
                        </td>
